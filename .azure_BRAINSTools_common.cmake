...
set(dashboard_git_url "https://itk.org/BRAINSTools.git")
endif()
...
if(EXISTS ${CTEST_SOURCE_DIRECTORY})
  ...
  if(vcs_refresh AND "${CTEST_SOURCE_DIRECTORY}" MATCHES "/(BRAINSTools|Insight)[^/]*")
...
macro(safe_message)
  if(NOT "${CMAKE_VERSION}" VERSION_LESS 3.10 OR NOT safe_message_skip)
    message(${ARGN})
  endif()
endmacro()
