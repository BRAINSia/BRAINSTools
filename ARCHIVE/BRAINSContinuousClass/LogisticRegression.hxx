...
template < typename TSampleType >
double
LogisticRegressionSample< TSampleType >::GetLabelProbability( unsigned int const & label )
{
...
template < typename TSampleType >
void
LogisticRegressionSample< TSampleType >::SetLabelProbability( unsigned int const & label, double const & probability )
{
...
LogisticRegressionSample< TSampleType >::GetSample() const
{
...
template < typename TSampleType >
void
LogisticRegressionSample< TSampleType >::SetSample( std::vector< TSampleType > & sample )
{
...
template < typename TSampleType >
void
LogisticRegressionSample< TSampleType >::SetLabel( unsigned int const & label )
{
  this->m_label = label;
...
template < typename TSampleType >
LogisticRegression< TSampleType >::LogisticRegression( const unsigned int featureCount,
                                                       const unsigned int totalSamples )
...
template < typename TSampleType >
void
LogisticRegression< TSampleType >::AddLabeledSample( LogisticRegressionSample< TSampleType > const & labeledSample )
{
...
template < typename TSampleType >
void
LogisticRegression< TSampleType >::TrainModel()
{
...
template < typename TSampleType >
void
LogisticRegression< TSampleType >::SetClassOneLabel( const unsigned int classLabel )
{
...
template < typename TSampleType >
void
LogisticRegression< TSampleType >::SetClassTwoLabel( const unsigned int classLabel )
{
...
template < typename TSampleType >
void
LogisticRegression< TSampleType >::ClassifySample( LogisticRegressionSample< TSampleType > & labeledSample )
{
