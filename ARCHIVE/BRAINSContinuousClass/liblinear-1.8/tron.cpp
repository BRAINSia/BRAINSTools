...
int
TRON::trcg( double delta, double * g, double * s, double * r )
{
  int      i, inc = 1;
  int      n = fun_obj->get_nr_variable();
  double   one = 1;
...
void
TRON::set_print_string( void ( *print_string )( const char * buf ) )
{
