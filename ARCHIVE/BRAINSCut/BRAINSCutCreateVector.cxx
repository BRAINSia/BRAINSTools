...
void
BRAINSCutCreateVector ::WriteCurrentVectors(InputVectorMapType &  pairedInput,
...
void
BRAINSCutCreateVector ::WriteHeaderFile(std::string vectorFilename,
                                        int         LocalinputVectorSize,
                                        int         LocaloutputVectorSize,
