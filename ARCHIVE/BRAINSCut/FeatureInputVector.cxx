...
bool
FeatureInputVector ::DoScalingUnitTests()
{
  bool        allOK = true;
  const float x = 1.0F;
...
unsigned int
FeatureInputVector ::GetInputVectorSize()
{
...
FeatureInputVector ::SetNormalizationParameters( std::string ROIName )
{
        ...
        ++eachTypeOfImage )
  {
    ...
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Maximum :: " << m_statistics[ROIName][ImageTypeNumber]["Maximum"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Mean :: " << m_statistics[ROIName][ImageTypeNumber]["Mean"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Sigma :: " << m_statistics[ROIName][ImageTypeNumber]["Sigma"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Median :: " << m_statistics[ROIName][ImageTypeNumber]["Median"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_01 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_01"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_05 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_05"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_25 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_25"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_75 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_75"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_95 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_95"] << std::endl;
    std::cout << ROIName << " :: " << ImageTypeNumber
              << " :: Q_99 :: " << m_statistics[ROIName][ImageTypeNumber]["Q_99"] << std::endl;
    ++ImageTypeNumber;
  }
