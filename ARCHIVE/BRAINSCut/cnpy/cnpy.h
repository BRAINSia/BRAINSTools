...
namespace cnpy {
    ...
    template<typename T> std::vector<char> create_npy_header(const T*  const /*USED ONLY FOR TEMPLATE GENERATEION data*/, const unsigned int* shape, const unsigned int ndims) {
