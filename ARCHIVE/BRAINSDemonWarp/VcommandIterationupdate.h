...
public:
  ...
  using VectorDiffeomorphicDemonsRegistrationFilterType =
    itk::VectorDiffeomorphicDemonsRegistrationFilter<VectorImageType, VectorImageType, DisplacementFieldType>;
  ...
  using MultiResRegistrationFilterType =
    itk::MultiResolutionPDEDeformableRegistration<InternalImageType, InternalImageType, DisplacementFieldType, TPixel>;
...
public:
  ...
  Execute(const itk::Object * object, const itk::EventObject & event) override
  {
    ...
    else if (const DemonsRegistrationFilterType * Dfilter = dynamic_cast<const DemonsRegistrationFilterType *>(object))
    {
      ...
      deffield = const_cast<DemonsRegistrationFilterType *>(Dfilter)->GetDisplacementField();
               ...
               dynamic_cast<const VectorDiffeomorphicDemonsRegistrationFilterType *>(object))
    {
...
protected:
  ...
  ~VCommandIterationUpdate() override { this->m_Fid.close(); }
};
