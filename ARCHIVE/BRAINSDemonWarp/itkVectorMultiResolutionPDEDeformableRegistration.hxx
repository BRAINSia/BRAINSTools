...
VectorMultiResolutionPDEDeformableRegistration<TFixedImage, TMovingImage, TDisplacementField, TRealType>::
...
template <typename TFixedImage, typename TMovingImage, typename TDisplacementField, typename TRealType>
void
VectorMultiResolutionPDEDeformableRegistration<TFixedImage, TMovingImage, TDisplacementField, TRealType>::SetFixedImage(
...
VectorMultiResolutionPDEDeformableRegistration<TFixedImage, TMovingImage, TDisplacementField, TRealType>::GetFixedImage(
  void) const
{
...
template <typename TFixedImage, typename TMovingImage, typename TDisplacementField, typename TRealType>
void
VectorMultiResolutionPDEDeformableRegistration<TFixedImage, TMovingImage, TDisplacementField, TRealType>::GenerateData()
{
