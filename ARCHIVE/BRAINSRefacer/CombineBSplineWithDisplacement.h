...
template < typename TReferenceImageType, typename TOutputVectorImageType, typename PixelType, unsigned int NDimension,
           unsigned int NBSplineOrder >
class CombineBSplineWithDisplacement : public itk::ImageToImageFilter< TReferenceImageType, TOutputVectorImageType >
{
public:
  ...
  itkSetMacro( Verbose, bool ) itkSetMacro( Debug, bool )
    ...
    itkSetMacro( BSplineInput, BSplinePointer ) itkGetMacro( BSplineInput, BSplinePointer )

      itkSetMacro( DistanceMap, ImageTypePointer ) itkGetMacro( DistanceMap, ImageTypePointer )

        itkSetMacro( ComposedImage, DisplacementFieldPointer ) itkGetMacro( ComposedImage, DisplacementFieldPointer )

          protected : CombineBSplineWithDisplacement()
  {
  ...
  GenerateData() override
  {
    ...
    using TransformToDisplacementFilterType =
      itk::TransformToDisplacementFieldFilter< DisplacementFieldImageType, PixelType >;
    typename TransformToDisplacementFilterType::Pointer bSplineDisplacementFieldGenerator =
    ...
    using ImageExtractionFilterType =
      typename itk::VectorIndexSelectionCastImageFilter< DisplacementFieldImageType, ImageType >;
