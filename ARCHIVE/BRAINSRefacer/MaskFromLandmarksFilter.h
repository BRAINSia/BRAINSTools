...
class MaskFromLandmarksFilter : public itk::ImageToImageFilter< TInputImage, TInputMask >
{
public:
  ...
  itkTypeMacro( Self, ImageToImageFilter )
    ...
    itkSetMacro( LandmarksFileName, std::string ) itkSetMacro( ReverseMask, bool ) itkSetMacro( Verbose, bool )
      itkSetMacro( Debug, bool )

        protected : MaskFromLandmarksFilter()
  {
