...
main( int argc, char ** argv )
{
  ...
  if ( distanceToHull )
  {
    ...
    {
      // find closest point
      cellLocator->FindClosestPoint( surface->GetPoint( i ), closepoint, cellId, subId, distHull );
  ...
  if ( corticalThickness )
  {
    ...
    {
      // find closest point
      cellLocator_thickness->FindClosestPoint( surface->GetPoint( i ), closepoint, cellId, subId, thickness );
      // convert dist2 to dist
