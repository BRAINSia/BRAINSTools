 ...
 *
 *=========================================================================*/
#ifndef __itkIcosahedralRegularSphereMeshSource_hxx
#define __itkIcosahedralRegularSphereMeshSource_hxx
...
IcosahedralRegularSphereMeshSource< TOutputMesh >::IcosahedralRegularSphereMeshSource()
{
  /**
   * Create the output
   */
...
template < typename TOutputMesh >
void
IcosahedralRegularSphereMeshSource< TOutputMesh >::GenerateData()
{
  ...
  static double IcosaPoints[] = { 0.0, d,  -c,  0.0, d,  c,  0.0, -d,  c, -d, c,   0.0, -d, -c,  0.0, d, c,   0.0,
                                  d,   -c, 0.0, 0.0, -d, -c, c,   0.0, d, -c, 0.0, d,   -c, 0.0, -d,  c, 0.0, -d };

  static unsigned int IcosaVerts[] = { 0, 5, 3, 1, 3,  5, 1,  2, 9,  1,  8, 2,  0, 7,  11, 0,  10, 7, 2, 6,
                                       4, 7, 4, 6, 3,  9, 10, 4, 10, 9,  5, 11, 8, 6,  8,  11, 1,  9, 3, 1,
                                       5, 8, 0, 3, 10, 0, 11, 5, 7,  10, 4, 7,  6, 11, 2,  4,  9,  2, 8, 6 };
...
IcosahedralRegularSphereMeshSource< TOutputMesh >::Divide( const PointType & p1, const PointType & p2 ) const
{
  PointType p;
  PointType f;
  PointType result;
...
template < typename TOutputMesh >
void
IcosahedralRegularSphereMeshSource< TOutputMesh >::AddCell( OutputMeshType * mesh, const unsigned long * pointIds,
                                                            unsigned long idx )
{
...
template < typename TOutputMesh >
void
IcosahedralRegularSphereMeshSource< TOutputMesh >::PrintSelf( std::ostream & os, Indent indent ) const
{
