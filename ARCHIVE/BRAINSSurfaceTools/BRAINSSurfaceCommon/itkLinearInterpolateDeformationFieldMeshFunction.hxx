...
template <typename TInputMesh, typename TDestinationPointsContainer>
void
LinearInterpolateDeformationFieldMeshFunction<TInputMesh, TDestinationPointsContainer>::PrintSelf(std::ostream & os,
                                                                                                  Indent indent) const
{
...
bool
LinearInterpolateDeformationFieldMeshFunction<TInputMesh, TDestinationPointsContainer>::Evaluate(
  const DestinationPointsContainerType * field,
