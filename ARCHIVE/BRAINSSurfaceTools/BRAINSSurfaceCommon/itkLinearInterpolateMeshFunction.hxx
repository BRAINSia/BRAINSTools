...
template <typename TInputMesh>
void
LinearInterpolateMeshFunction<TInputMesh>::GetDerivativeFromPixelsAndBasis(PixelType          pixelValue1,
                                                                           PixelType          pixelValue2,
                                                                           PixelType          pixelValue3,
                                                                           const VectorType & m_U12,
                                                                           const VectorType & m_U32,
...
void
LinearInterpolateMeshFunction<TInputMesh>::GetJacobianFromVectorAndBasis(const TArray &     pixelArray1,
                                                                         const TArray &     pixelArray2,
                                                                         const TArray &     pixelArray3,
                                                                         const VectorType & m_U12,
                                                                         const VectorType & m_U32,
                                                                         TMatrix &          jacobian)
{
