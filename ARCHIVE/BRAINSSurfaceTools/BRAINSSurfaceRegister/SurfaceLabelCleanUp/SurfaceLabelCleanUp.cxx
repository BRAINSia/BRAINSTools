...
int
SurfaceConnectivityCells( vtkSmartPointer< vtkPolyData > mesh );

int
SurfaceConnectivityPoints( vtkSmartPointer< vtkPolyData > mesh );

int
RemoveIsolatedPoints( vtkSmartPointer< vtkPolyData > mesh );

void
FlipSharpTriangles( vtkSmartPointer< vtkPolyData > mesh );
...
SurfaceConnectivityCells( vtkSmartPointer< vtkPolyData > mesh )
{
  ...
  vtkSmartPointer< vtkPolyDataConnectivityIDFilter > connect =
    vtkSmartPointer< vtkPolyDataConnectivityIDFilter >::New();
