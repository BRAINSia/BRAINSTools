...
set_up(genus0parameters * g0)
{
  ...
  if ((autocrop[0][0] > autocrop[0][1]) || (autocrop[1][0] > autocrop[1][1]) || (autocrop[2][0] > autocrop[2][1]))
  {
...
save_image(genus0parameters * g0)
{
  ...
  dims[2] = img_depth;
  if (GetSurf(
        zpic, 1, dims, g0->connectivity, &(g0->triangles), &(g0->vertices), &(g0->tri_count), &(g0->vert_count), g0))
  {
    return 1;
  }
