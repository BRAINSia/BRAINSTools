...
//----------------------------------------------------------------------------
void
vtkITKArchetypeImageSeriesScalarReader::PrintSelf( ostream & os, vtkIndent indent )
{
...
int
vtkITKArchetypeImageSeriesScalarReader::RequestData( vtkInformation *        vtkNotUsed( request ),
...
#define vtkITKExecuteDataFromSeries( typeN, type )                                                                     \
  ...
  {                                                                                                                    \
    ...
    DownCast< type >( data->GetPointData()->GetScalars() )                                                             \
      ->SetVoidArray( ptr, PixelContainer##typeN->Size(), 0, vtkDataArrayTemplate< type >::VTK_DATA_ARRAY_DELETE );    \
...
#define vtkITKExecuteDataFromFile( typeN, type )                                                                       \
  ...
  {                                                                                                                    \
    ...
    DownCast< type >( data->GetPointData()->GetScalars() )                                                             \
      ->SetVoidArray( ptr, PixelContainer2##typeN->Size(), 0, vtkDataArrayTemplate< type >::VTK_DATA_ARRAY_DELETE );   \
...
void
vtkITKArchetypeImageSeriesScalarReader::ReadProgressCallback( itk::ProcessObject * obj, const itk::ProgressEvent &,
                                                              void *               data )
{
