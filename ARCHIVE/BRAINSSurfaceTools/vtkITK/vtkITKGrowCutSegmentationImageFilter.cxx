...
void
vtkITKImageGrowCutHandleProgressEvent(itk::Object *            caller,
...
void
vtkITKImageGrowCutExecute3D(vtkImageData *              inData,
                            IT1 *                       inPtr1,
                            OT *                        inPtr2,
                            OT *                        inPtr3,
                            OT *                        output,
                            ...
                            itk::CStyleCommand::Pointer progressCommand)
{
  ...
  memcpy(output, outputImage->GetBufferPointer(), outputImage->GetBufferedRegion().GetNumberOfPixels() * sizeof(OT));
}
...
void
ExecuteGrowCut(vtkITKGrowCutSegmentationImageFilter * self,
               vtkImageData *                         input1,
               vtkImageData *                         input2,
               vtkImageData *                         input3,
...
#else
    vtkTemplateMacro(ExecuteGrowCut(this, input1, input2, input3, out, outInfo, static_cast<VTK_TT *>(nullptr)));
#endif
    break;
  }
}
...
//-----------------------------------------------------------------------------
int
vtkITKGrowCutSegmentationImageFilter::RequestInformation(vtkInformation *        request,
