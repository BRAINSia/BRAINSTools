...
template < typename T >
void
vtkITKLevelTracing3DTrace( vtkITKLevelTracing3DImageFilter * vtkNotUsed( self ), T * scalars, int dims[3],
                           int extent[6], double origin[3], double spacing[3], unsigned char * oscalars, int seed[3] )
{
...
//
int
vtkITKLevelTracing3DImageFilter::RequestData( vtkInformation *        vtkNotUsed( request ),
...
int
vtkITKLevelTracing3DImageFilter::RequestInformation( vtkInformation * request, vtkInformationVector ** inputVector,
...
int
vtkITKLevelTracing3DImageFilter::FillInputPortInformation( int, vtkInformation * info )
{
...
void
vtkITKLevelTracing3DImageFilter::PrintSelf( ostream & os, vtkIndent indent )
{
