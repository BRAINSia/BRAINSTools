...
template < typename T >
void
vtkITKLevelTracingTrace( vtkITKLevelTracingImageFilter * vtkNotUsed( self ), T * scalars, int dims[3], int extent[6],
                         double origin[3], double spacing[3], vtkPoints * newPoints, vtkCellArray * newPolys,
...
//
int
vtkITKLevelTracingImageFilter::RequestData( vtkInformation * vtkNotUsed( request ), vtkInformationVector ** inputVector,
...
#  define vtkTemplateMacroCase_ll( typeN, type, call )
  ...
  if ( inScalars->GetNumberOfComponents() == 1 )
  {
    ...
    {
      vtkTemplateMacro( vtkITKLevelTracingTrace( this,
...
int
vtkITKLevelTracingImageFilter::FillInputPortInformation( int, vtkInformation * info )
{
...
void
vtkITKLevelTracingImageFilter::PrintSelf( ostream & os, vtkIndent indent )
{
