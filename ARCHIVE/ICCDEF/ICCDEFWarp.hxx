...
ICCDEFWarp<TImage, TRealImage, TOutputImage>::ICCDEFWarp()
{
...
template <typename TImage, typename TRealImage, typename TOutputImage>
void
ICCDEFWarp<TImage, TRealImage, TOutputImage>::InitializePreprocessor()
{
...
template <typename TImage, typename TRealImage, typename TOutputImage>
void
ICCDEFWarp<TImage, TRealImage, TOutputImage>::InitializeRegistrator()
{
  ...
  this->m_Registrator->SetForwardDisplacementFieldOutputName(this->GetForwardDisplacementFieldOutputName());
  this->m_Registrator->SetBackwardDisplacementFieldOutputName(this->GetBackwardDisplacementFieldOutputName());
