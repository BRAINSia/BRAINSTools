...
ICCIterativeInverseDisplacementFieldImageFilter<TInputImage, TOutputImage>::ComputeInverseThreaderCallback(void * arg)
{
  ThreadStruct * str;
    ...
    float               fDispU1, fDispU2, fDispU3;
    {
      ...
      do
      {
        do
        {
          ...
          ((std::abs(fDelta1) > fEpsilon1) || (std::abs(fDelta2) > fEpsilon2) || (std::abs(fDelta3) > fEpsilon3)) &&
  ...
  InputImageSizeType size)
{
...
#endif
  {
    ...
    if ((iFlooredX > 0) && (iFlooredX < nx - 1) && (iFlooredY > 0) && (iFlooredY < ny - 1) && (iFlooredZ > 0) &&
        (iFlooredZ < nz - 1))
    {
...
ICCIterativeInverseDisplacementFieldImageFilter<TInputImage, TOutputImage>::BoundaryIndexing(int       iDesiredX,
                                                                                             int       iDesiredY,
                                                                                             int       iDesiredZ,
                                                                                             const int iMaxX,
                                                                                             const int iMaxY,
