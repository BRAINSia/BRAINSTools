...
class RF8BRAINSCutWrapperCLInputSpec(CommandLineInputSpec):
    ...
    inputSubjectTotalGMFilename = File(
        desc="Subject Total GM Volume",
        exists=True,
        mandatory=True,
        argstr="--inputSubjectTotalGMFilename %s",
    )
    inputSubjectRegistrationROIFilename = File(
        desc="Subject Registration ROIMask Volume",
        exists=True,
        mandatory=True,
    ...
    inputTemplateRegistrationROIFilename = File(
        desc="Atlas Template MaskROI image",
        exists=False,
        mandatory=False,
