"""
Example)
  python ./BAWScreenShots.py -i  ./small_list.csv -d /Shared/sinapse/CACHE/20160202_PREDICTHD_base_Results/ -c /scratch/eunyokim/20160202_PREDICTHD_base_Snapshot/
"""
import sys, getopt
import os
import ast
...
def main(argv=None):
    ...
    try:
        opts, args = getopt.getopt(argv,"hi:d:c:s:",["inputFilename=",
                                                   "inputDirectory=",
                                                   "cacheDirectory=",
                                                   "inputSubDirectory="])
    except getopt.GetoptError:
        print """minipigTemplateBuilder.py
              -i <inputfile>
              -d <inputDirectory>
              -c <cacheDirectory>
              -s <inputSubDirectory>"""
    ...
    for oneSession in inputDictList:
        ...
        for filename in searchVolumeList:
            ...
            if os.path.isfile( fullPathFilename ):
                ...
                print "    {0} does not exist. Skip.".format(fullPathFilename)
        ...
        for filename in searchBinaryVolumeList:
            ...
            if os.path.isfile( fullPathBinaryFilename):
                ...
                print "    {0} does not exist. Skip.".format(fullPathBinaryFilename)
