...
class SimilarityIndexInputSpec(CommandLineInputSpec):
    ...
    ANNContinuousVolume = File(desc="ANN Continuous volume to be compared to the manual volume", exists=True,
    ...
    thresholdInterval = traits.Float(desc="Threshold interval to compute similarity index between zero and one",
...
class BRAINSTalairachInputSpec(CommandLineInputSpec):
    ...
    inputVolume = File(desc="Input image used to define physical space of images", exists=True,
                       argstr="--inputVolume %s")
    outputBox = traits.Either(traits.Bool, File(), hash_files=False,
                              desc="Name of the resulting Talairach Bounding Box file", argstr="--outputBox %s")
    outputGrid = traits.Either(traits.Bool, File(), hash_files=False, desc="Name of the resulting Talairach Grid file",
                               argstr="--outputGrid %s")
...
class BRAINSTalairachMaskInputSpec(CommandLineInputSpec):
    inputVolume = File(desc="Input image used to define physical space of resulting mask", exists=True,
                       argstr="--inputVolume %s")
    talairachParameters = File(desc="Name of the Talairach parameter file.", exists=True,
                               argstr="--talairachParameters %s")
    talairachBox = File(desc="Name of the Talairach box file.", exists=True, argstr="--talairachBox %s")
    hemisphereMode = traits.Enum("left", "right", "both", desc="Mode for box creation: left, right, both",
    ...
    outputVolume = traits.Either(traits.Bool, File(), hash_files=False,
                                 desc="Output filename for the resulting binary image", argstr="--outputVolume %s")
