...
class UKFTractographyInputSpec(CommandLineInputSpec):
    ...
    seedsFile = File(
        ...
        exists=True, argstr="--seedsFile %s")
    ...
    tracts = traits.Either(traits.Bool, File(), hash_files=False, desc="Tracts generated, with first tensor output",
                           argstr="--tracts %s")
    writeAsciiTracts = traits.Bool(desc="Write tract file as a VTK binary data file", argstr="--writeAsciiTracts ")
    writeUncompressedTracts = traits.Bool(desc="Write tract file as a VTK uncompressed data file",
    ...
    numTensor = traits.Enum("1", "2", desc="Number of tensors used", argstr="--numTensor %s")
    freeWater = traits.Bool(
        ...
        argstr="--freeWater ")
    recordFA = traits.Bool(desc="Whether to store FA. Attaches field 'FA', and 'FA2' for 2-tensor case to fiber. ",
                           argstr="--recordFA ")
    ...
    recordState = traits.Bool(desc="Whether to attach the states to the fiber. Will generate field 'state'.",
                              argstr="--recordState ")
    recordCovariance = traits.Bool(desc="Whether to store the covariance. Will generate field 'covariance' in fiber.",
                                   argstr="--recordCovariance ")
    minFA = traits.Float(desc="Abort the tractography when the Fractional Anisotropy is less than this value",
                         argstr="--minFA %f")
    minGA = traits.Float(desc="Abort the tractography when the Generalized Anisotropy is less than this value",
                         argstr="--minGA %f")
    ...
    Qw = traits.Float(desc="Process noise for free water weights, ignored if no free water estimation",
                      argstr="--Qw %f")
    ...
    tractsWithSecondTensor = traits.Either(traits.Bool, File(), hash_files=False,
