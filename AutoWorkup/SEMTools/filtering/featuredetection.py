...
class GenerateSummedGradientImageInputSpec(CommandLineInputSpec):
    ...
    outputFileName = traits.Either(traits.Bool, File(), hash_files=False, desc="(required) output file name",
...
class DilateImageInputSpec(CommandLineInputSpec):
    ...
    outputVolume = traits.Either(traits.Bool, File(), hash_files=False, desc="Required: output image",
...
class GenerateTestImageInputSpec(CommandLineInputSpec):
    ...
    outputVolume = traits.Either(traits.Bool, File(), hash_files=False, desc="(required) output file name",
                                 argstr="--outputVolume %s")
...
class HammerAttributeCreatorInputSpec(CommandLineInputSpec):
    ...
    outputVolumeBase = traits.Str(desc="Required: output image base name to be appended for each feature vector.",
...
class DistanceMapsInputSpec(CommandLineInputSpec):
    ...
    inputMaskVolume = File(desc="Required: input brain mask image", exists=True, argstr="--inputMaskVolume %s")
    inputTissueLabel = traits.Int(desc="Required: input integer value of tissue type used to calculate distance",
...
class STAPLEAnalysisInputSpec(CommandLineInputSpec):
    ...
    inputLabelVolume = InputMultiPath(File(exists=True), desc="Required: input label volume",
