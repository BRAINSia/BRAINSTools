...
class fcsv_to_hdf5InputSpec(CommandLineInputSpec):
    versionID = traits.Str(
        ...
        argstr="--versionID %s")
    landmarksInformationFile = traits.Either(traits.Bool, File(), hash_files=False,
                                             desc=",         name of HDF5 file to write matrices into,       ",
                                             argstr="--landmarksInformationFile %s")
    landmarkTypesList = File(desc=",         file containing list of landmark types,       ", exists=True,
                             argstr="--landmarkTypesList %s")
    modelFile = traits.Either(traits.Bool, File(), hash_files=False,
...
class FindCenterOfBrainInputSpec(CommandLineInputSpec):
    ...
    debugAfterGridComputationsForegroundImage = traits.Either(traits.Bool, File(), hash_files=False,
...
"""
    ...
    _outputs_filenames = {'debugClippedImageMask': 'debugClippedImageMask.nii',
                          'debugTrimmedImage': 'debugTrimmedImage.nii', 'debugDistanceImage': 'debugDistanceImage.nii',
                          'debugGridImage': 'debugGridImage.nii', 'clippedImageMask': 'clippedImageMask.nii',
