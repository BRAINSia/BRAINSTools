...
## HACK
atlas_file_names = ["ExtendedAtlasDefinition.xml",
...
atlas_file_keys = [basename(fn).replace('.nii.gz', '').replace('.', '_') for fn in atlas_file_names]
...
deformations = ['BRAINMASK', 'T1', 'T2'] + posteriors  #<-- deepcopy
