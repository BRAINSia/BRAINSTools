...
int
simpleRunEMS( std::string t1Volume, std::string t2Volume, std::string pdVolume, std::string templateVolume,
              int maxIteration, std::string OutputFileNamePrefix, std::vector< std::string > & priorsList,
              std::vector< double > & priorsWeightList, bool warp, int degreeOfBiasFieldCorrection,
...
main( int argc, char * argv[] )
{
  ...
  const int status = simpleRunEMS< float, float >( t1Volume,
                                                   t2Volume,
                                                   pdVolume,
                                                   templateVolume,
                                                   maxIteration,
