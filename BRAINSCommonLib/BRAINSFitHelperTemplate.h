...
public:
  ...
  using ImageMetricType = typename itk::ImageToImageMetricv4<FixedImageType, MovingImageType, FixedImageType, RealType>;
  ...
  itkSetMacro(RemoveIntensityOutliers, double);
  itkGetConstMacro(RemoveIntensityOutliers, double);
