...
DWIMetaDataDictionaryValidator::MetaDataDictionaryType
DWIMetaDataDictionaryValidator::GetMetaDataDictionary()
{
  return m_dict;
}

void
DWIMetaDataDictionaryValidator::SetMetaDataDictionary( DWIMetaDataDictionaryValidator::ConstMetaDataDictionaryType rhs )
{
  m_dict = rhs;
}

DWIMetaDataDictionaryValidator::RotationMatrixType
DWIMetaDataDictionaryValidator::GetMeasurementFrame() const
{
...
DWIMetaDataDictionaryValidator::Double3x1ArrayType
...
double
DWIMetaDataDictionaryValidator::GetBValue() const
{
  double      retval = 0.0;
  std::string valstr;
...
void
DWIMetaDataDictionaryValidator::GenericSetStringVector( const std::vector< std::string > & values,
                                                        const std::string &                KeyBaseName )
{
  for ( size_t index = 0; index < values.size(); ++index )
  {
    ...
    if ( values[index] != "???" )
    {
      itk::EncapsulateMetaData< std::string >( this->m_dict, currKey, values[index] );
    }
  }
}

void
DWIMetaDataDictionaryValidator::GenericSetDoubleVector( const std::vector< double > & values,
                                                        const std::string &           KeyBaseName )
{
  for ( size_t index = 0; index < values.size(); ++index )
  {
    ...
    {
      itk::EncapsulateMetaData< double >( this->m_dict, currKey, values[index] );
    }
  }
}
...
DWIMetaDataDictionaryValidator::GenericGetStringVector( const std::string & KeyBaseName, const size_t numElements,
...
std::vector< double >
DWIMetaDataDictionaryValidator::GenericGetDoubleVector( const std::string & KeyBaseName, const size_t numElements,
...
std::vector< std::string >
DWIMetaDataDictionaryValidator::GetCenterings() const
{
...
void
DWIMetaDataDictionaryValidator::SetCenterings( const std::vector< std::string > & values )
{
...
std::vector< double >
DWIMetaDataDictionaryValidator::GetThicknesses() const
{
...
void
DWIMetaDataDictionaryValidator::SetThicknesses( const std::vector< double > & values )
{
  const std::string KeyBaseName( "NRRD_thicknesses" );
...
std::string
DWIMetaDataDictionaryValidator::GetModality() const
{
...
void
DWIMetaDataDictionaryValidator::SetModality( const std::string & value )
{
  const std::string KeyBaseName( "modality" );
  if ( value != "DWMRI" )
  {
