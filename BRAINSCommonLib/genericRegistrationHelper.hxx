...
template <typename TTransformType,
          ...
          typename MetricType>
MultiModal3DMutualRegistrationHelper<TTransformType,
                                     TOptimizer,
                                     TFixedImage,
                                     TMovingImage,
                                     MetricType>::MultiModal3DMutualRegistrationHelper()
  : m_FixedImage(nullptr)
  , // has to be provided by the user.
  m_MovingImage(nullptr)
  , // has to be provided by the user.
  m_FixedImage2(nullptr)
  , // has to be provided by the user.
  m_MovingImage2(nullptr)
  , // has to be provided by the user.
  m_CompositeTransform(nullptr)
  , /* It is set by initial moving transform and
...
template <typename TTransformType,
          ...
          typename MetricType>
ModifiedTimeType
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::GetMTime()
  const
{
...
template <typename TTransformType,
          ...
          typename MetricType>
void
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::GenerateData()
{
  this->Update();
}
...
template <typename TTransformType,
          ...
          typename MetricType>
void
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::SetFixedImage(
...
template <typename TTransformType,
          ...
          typename MetricType>
void
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::SetMovingImage(
...
template <typename TTransformType,
          ...
          typename MetricType>
void
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::SetFixedImage2(
  FixedImagePointer fixedImage2)
{
...
template <typename TTransformType,
          ...
          typename TMovingImage,
          typename MetricType>
const typename MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::
  TransformOutputType *
  MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::GetOutput()
    const
{
...
template <typename TTransformType,
          ...
          typename MetricType>
DataObject::Pointer
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::MakeOutput(
  unsigned int output)
{
  switch (output)
  {
...
template <typename TTransformType,
          ...
          typename MetricType>
void
MultiModal3DMutualRegistrationHelper<TTransformType, TOptimizer, TFixedImage, TMovingImage, MetricType>::PrintSelf(
  std::ostream & os,
  Indent         indent) const
{
