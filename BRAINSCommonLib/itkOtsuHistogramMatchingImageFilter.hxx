...
OtsuHistogramMatchingImageFilter< TInputImage, TOutputImage, THistogramMeasurement >::BeforeThreadedGenerateData()
{
  ...
  this->ConstructHistogram(
    reference, m_ReferenceMask, m_ReferenceHistogram, m_ReferenceMinValue, m_ReferenceMaxValue );
...
OtsuHistogramMatchingImageFilter< TInputImage, TOutputImage, THistogramMeasurement >::AfterThreadedGenerateData()
{
  ...
  ComputeRobustMinMaxMean< TOutputImage, SpatialObjectType >( 0.005,
                                                              output.GetPointer(),
                                                              this->m_SourceMask.GetPointer(),
                                                              m_OutputMinValue,
                                                              m_OutputMaxValue,
                                                              m_OutputMeanValue );
...
OtsuHistogramMatchingImageFilter< TInputImage, TOutputImage, THistogramMeasurement >::ConstructHistogram(
  const InputImageType * image, const SpatialObjectType::Pointer mask, HistogramType * histogram,
