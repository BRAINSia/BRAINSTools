  ...
  */
  ...
  if( myEvent == vtkCommand::KeyPressEvent )
    ...
    if( key == 'C' || key == 'c' )  // create a new actor
      {
      QString initPos =
        initPos.number( ( physicalExtent[0] + physicalExtent[1] ) / 2.0 ) + " "
  ...
  // handling mouse myEvent
    ...
    // linear mapping
    double zFactor =
      ( center[centerMapped] - physicalExtentIdentity[2 * centerMapped] )
    ...
    if( type == 2 )
      ...
      */
      ...
      labelPosRatio[0] =
        ( m_valueReceiveZ - bound[0] ) / ( bound[1] - bound[0] );
      labelPosRatio[1] =
        ( m_valueSendX - bound[2] ) / ( bound[3] - bound[2] );
      labelPosRatio[2] =
        ( m_valueSendY - bound[4] ) / ( bound[5] - bound[4] );
      }
    else if( type == 3 )
      {   // coronal view mode ( LSA )
      ...
      */
      ...
      // label postion ratio for inter-viewer communication
      labelPosRatio[0] =
        ( m_valueSendX - bound[0] ) / ( bound[1] - bound[0] );
      labelPosRatio[1] =
        ( m_valueReceiveZ - bound[2] ) / ( bound[3] - bound[2] );
      labelPosRatio[2] =
        ( m_valueSendY - bound[4] ) / ( bound[5] - bound[4] );
      }
    else
      ...
      */
      ...
      labelPosRatio[0] =
        ( m_valueSendX - bound[0] ) / ( bound[1] - bound[0] );
      labelPosRatio[1] =
        ( m_valueSendY - bound[2] ) / ( bound[3] - bound[2] );
      labelPosRatio[2] =
        ( m_valueReceiveZ - bound[4] ) / ( bound[5] - bound[4] );
      }
...
void QVTKInteractionCallback::setValueZLocation(const int zLocation)
{
  if( ( m_valueReceiveZ >= zLocation / m_precision - 0.5 )
      && ( m_valueReceiveZ <  zLocation / m_precision + 0.5 ) )
    {
    return;
    }
  ...
  */
  ...
  if( type == 2 )
    ...
    center =
      ( m_valueReceiveZ - physicalExtent[0] ) / ( physicalExtent[1] - physicalExtent[0] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
    ...
    // calculate the center value from m_valueReceiveZ
    center =
      physicalExtentIdentity[2 * centerMapped + 1]
    ...
    // calculate the center value from m_valueReceiveZ
    center =
      ( m_valueReceiveZ - physicalExtent[4] ) / ( physicalExtent[5] - physicalExtent[4] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
...
// slice viewer
void QVTKInteractionCallback::setValueXLocation(const double xLocation)
{
  // avoid infinite loop and update internal z-axis location
  ...
  */
  ...
  if( type == 2 )
    ...
    center =
      ( m_valueReceiveX - physicalExtent[0] ) / ( physicalExtent[1] - physicalExtent[0] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
    ...
    // calculate the center value from m_valueReceiveX
    center =
      ( m_valueReceiveX - physicalExtent[4] ) / ( physicalExtent[5] - physicalExtent[4] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
...
// slice viewer
void QVTKInteractionCallback::setValueYLocation(const double yLocation)
{
  // avoid infinite loop and update internal z-axis location
  ...
  */
  ...
  if( type == 2 )
    ...
    center =
      ( m_valueReceiveY - physicalExtent[0] ) / ( physicalExtent[1] - physicalExtent[0] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
    ...
    // calculate the center value from m_valueReceiveY
    center =
      ( m_valueReceiveY - physicalExtent[4] ) / ( physicalExtent[5] - physicalExtent[4] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
...
void QVTKInteractionCallback::receiveLabelPos(double *pos)
{
  ...
  if( type == 2 )
    ...
    center =
      ( pos[0] - physicalExtent[0] ) / ( physicalExtent[1] - physicalExtent[0] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
    ...
    center =
      ( pos[2] - physicalExtent[4] ) / ( physicalExtent[5] - physicalExtent[4] )
      * ( physicalExtentIdentity[2 * centerMapped + 1] - physicalExtentIdentity[2 * centerMapped] )
      + physicalExtentIdentity[2 * centerMapped];
...
void QVTKInteractionCallback::createListAddButtonSlot()
{
  double *physicalExtent = m_physicalExtent;
  QString initPos =
    initPos.number( ( physicalExtent[0] + physicalExtent[1] ) / 2.0 ) + " "
