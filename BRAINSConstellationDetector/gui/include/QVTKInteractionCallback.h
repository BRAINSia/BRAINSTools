...
public slots:
  ...
  void
  createListAddButtonSlot(); // receive the request from add button
...
signals:
  ...
  void
  checkVisibility(); // check visibility request to list
