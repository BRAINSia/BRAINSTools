             ...
             const double                  thickness)
{
  ...
  return cylinder_side_squared < thickness * thickness || PointDist2.GetNorm() < 2;
}
                      ...
                      const SImageType::PointType &         VN42)
{
  ...
  for (unsigned int which = 0; which < 4; which++)
  {
    ...
    for (; !rgbIt.IsAtEnd() && !sIt.IsAtEnd(); ++sIt, ++rgbIt)
    {
      ...
      const auto                  p = orientedImage->template TransformIndexToPhysicalPoint<double>(index);
                        ...
                        const std::string &           fname)
{
  ...
  for (; !sIt.IsAtEnd(); ++sIt)
  {
    ...
    const auto                  p = inputImage->template TransformIndexToPhysicalPoint<double>(index);
              ...
              const LandmarkIO::VersorRigidTransformType::ConstPointer & versorTransform)
{
  ...
  // Common mrml header
  myfile
    << "<MRML  version=\"13298\" userTags=\"\">  \n  <Selection  \n  id=\"vtkMRMLSelectionNode1\"  "
       "name=\"vtkMRMLSelectionNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "activeVolumeID=\"vtkMRMLScalarVolumeNode2\"  secondaryVolumeID=\"NULL\"  activeLabelVolumeID=\"NULL\"  "
       "activeFiducialListID=\"vtkMRMLFiducialListNode1\"  activeROIListID=\"NULL\"  activeCameraID=\"NULL\"  "
       "activeViewID=\"NULL\"  activeLayoutID=\"vtkMRMLLayoutNode1\"></Selection>  \n  <Interaction  \n  "
       "id=\"vtkMRMLInteractionNode1\"  name=\"vtkMRMLInteractionNode1\"  hideFromEditors=\"true\"  "
       "selectable=\"true\"  selected=\"false\"  currentInteractionMode=\"ViewTransform\"  "
       "lastInteractionMode=\"ViewTransform\" ></Interaction>  \n  <Layout  \n  id=\"vtkMRMLLayoutNode1\"  "
       "name=\"vtkMRMLLayoutNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "currentViewArrangement=\"3\"  guiPanelVisibility=\"1\"  bottomPanelVisibility =\"0\"  guiPanelLR=\"0\"  "
       "collapseSliceControllers=\"0\"  \n  numberOfCompareViewRows=\"1\"  numberOfCompareViewColumns=\"1\"  "
       "numberOfLightboxRows=\"1\"  numberOfLightboxColumns=\"1\"  mainPanelSize=\"400\"  secondaryPanelSize=\"400\" "
       "></Layout>  \n  <TGParameters  \n  id=\"vtkMRMLChangeTrackerNode1\"  name=\"vtkMRMLChangeTrackerNode1\"  "
       "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  ROIMin=\"-1 -1 -1\"  ROIMax=\"-1 -1 -1\"  "
       "SegmentThresholdMin=\"-1\"  SegmentThresholdMax=\"-1\"  Analysis_Intensity_Flag=\"0\"  "
       "Analysis_Deformable_Flag=\"0\"  UseITK=\"1\"  RegistrationChoice=\"3\"  ROIRegistration=\"1\"  "
       "ResampleChoice=\"3\"  ResampleConst=\"0.5\" ></TGParameters>  \n  <Crosshair  \n  id=\"vtkMRMLCrosshairNode1\" "
       " name=\"vtkMRMLCrosshairNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "crosshairMode=\"NoCrosshair\"  navigation=\"true\"  crosshairBehavior=\"Normal\"  crosshairThickness=\"Fine\"  "
       "crosshairRAS=\"0 0 0\" ></Crosshair>  \n  <Slice  \n  id=\"vtkMRMLSliceNode1\"  name=\"Green\"  "
       "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  fieldOfView=\"374.356 322.12 0.534398\"  "
       "dimensions=\"430 370 1\"  activeSlice=\"0\"  layoutGridRows=\"1\"  layoutGridColumns=\"1\"  sliceToRAS=\"-1 0 "
       "0 2.04504 0 0 1 0 0 1 0 -9.66354 0 0 0 1\"  layoutName=\"Green\"  orientation=\"Coronal\"  jumpMode=\"1\"  "
       "sliceVisibility=\"false\"  widgetVisibility=\"false\"  useLabelOutline=\"false\"  sliceSpacingMode=\"0\"  "
       "prescribedSliceSpacing=\"1 1 1\" ></Slice>  \n  <SliceComposite  \n  id=\"vtkMRMLSliceCompositeNode1\"  "
       "name=\"vtkMRMLSliceCompositeNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "backgroundVolumeID=\"vtkMRMLScalarVolumeNode1\"  foregroundVolumeID=\"\"  labelVolumeID=\"\"  "
       "compositing=\"0\"  labelOpacity=\"1\"  linkedControl=\"0\"  foregroundGrid=\"0\"  backgroundGrid=\"0\"  "
       "labelGrid=\"1\"  fiducialVisibility=\"1\"  fiducialLabelVisibility=\"1\"  sliceIntersectionVisibility=\"0\"  "
       "layoutName=\"Green\"  annotationMode=\"All\"  doPropagateVolumeSelection=\"1\" ></SliceComposite>  \n  <Slice  "
       "\n  id=\"vtkMRMLSliceNode2\"  name=\"Red\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "fieldOfView=\"364.349 313.51 1.29601\"  dimensions=\"430 370 1\"  activeSlice=\"0\"  layoutGridRows=\"1\"  "
       "layoutGridColumns=\"1\"  sliceToRAS=\"-1 0 0 2.04504 0 1 0 -12.7088 0 0 1 0 0 0 0 1\"  layoutName=\"Red\"  "
       "orientation=\"Axial\"  jumpMode=\"1\"  sliceVisibility=\"false\"  widgetVisibility=\"false\"  "
       "useLabelOutline=\"false\"  sliceSpacingMode=\"0\"  prescribedSliceSpacing=\"1 1 1\" ></Slice>  \n  "
       "<SliceComposite  \n  id=\"vtkMRMLSliceCompositeNode2\"  name=\"vtkMRMLSliceCompositeNode2\"  "
       "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "backgroundVolumeID=\"vtkMRMLScalarVolumeNode1\"  foregroundVolumeID=\"\"  labelVolumeID=\"\"  "
       "compositing=\"0\"  labelOpacity=\"1\"  linkedControl=\"0\"  foregroundGrid=\"0\"  backgroundGrid=\"0\"  "
       "labelGrid=\"1\"  fiducialVisibility=\"1\"  fiducialLabelVisibility=\"1\"  sliceIntersectionVisibility=\"0\"  "
       "layoutName=\"Red\"  annotationMode=\"All\"  doPropagateVolumeSelection=\"1\" ></SliceComposite>  \n  <Slice  "
       "\n  id=\"vtkMRMLSliceNode3\"  name=\"Yellow\"  hideFromEditors=\"true\"  selectable=\"true\"  "
       "selected=\"false\"  fieldOfView=\"374.356 322.12 1.11022\"  dimensions=\"430 370 1\"  activeSlice=\"0\"  "
       "layoutGridRows=\"1\"  layoutGridColumns=\"1\"  sliceToRAS=\"0 0 1 0 -1 0 0 -12.7088 0 1 0 -9.66354 0 0 0 1\"  "
       "layoutName=\"Yellow\"  orientation=\"Sagittal\"  jumpMode=\"1\"  sliceVisibility=\"false\"  "
       "widgetVisibility=\"false\"  useLabelOutline=\"false\"  sliceSpacingMode=\"0\"  prescribedSliceSpacing=\"1 1 "
       "1\" ></Slice>  \n  <SliceComposite  \n  id=\"vtkMRMLSliceCompositeNode3\"  name=\"vtkMRMLSliceCompositeNode3\" "
       " hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "backgroundVolumeID=\"vtkMRMLScalarVolumeNode1\"  foregroundVolumeID=\"\"  labelVolumeID=\"\"  "
       "compositing=\"0\"  labelOpacity=\"1\"  linkedControl=\"0\"  foregroundGrid=\"0\"  backgroundGrid=\"0\"  "
       "labelGrid=\"1\"  fiducialVisibility=\"1\"  fiducialLabelVisibility=\"1\"  sliceIntersectionVisibility=\"0\"  "
       "layoutName=\"Yellow\"  annotationMode=\"All\"  doPropagateVolumeSelection=\"1\" ></SliceComposite>  \n  "
       "<ScriptedModule  \n  id=\"vtkMRMLScriptedModuleNode1\"  name=\"vtkMRMLScriptedModuleNode1\"  "
       "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\" ModuleName =\"Editor\" parameter0= \"label "
       "1\" ></ScriptedModule>  \n  <View  \n  id=\"vtkMRMLViewNode1\"  name=\"View6\"  hideFromEditors=\"false\"  "
       "selectable=\"true\"  selected=\"false\"  active=\"true\"  visibility=\"true\"  fieldOfView=\"200\"  "
       "letterSize=\"0.05\"  boxVisible=\"true\"  fiducialsVisible=\"true\"  fiducialLabelsVisible=\"true\"  "
       "axisLabelsVisible=\"true\"  backgroundColor=\"0.70196 0.70196 0.90588\"  animationMode=\"Off\"  "
       "viewAxisMode=\"LookFrom\"  spinDegrees=\"2\"  spinMs=\"5\"  spinDirection=\"YawLeft\"  rotateDegrees=\"5\"  "
       "rockLength=\"200\"  rockCount=\"0\"  stereoType=\"NoStereo\"  renderMode=\"Perspective\" ></View>  \n  <Camera "
       " \n  id=\"vtkMRMLCameraNode1\"  name=\"Camera6\"  hideFromEditors=\"false\"  selectable=\"true\"  "
       "selected=\"false\"  position=\"0 500 0\"  focalPoint=\"0 0 0\"  viewUp=\"0 0 1\"  parallelProjection=\"false\" "
  ...
  if (outputLandmarksInOutputSpace.compare("") != 0)
  {
    myfile << "<FiducialList\n id=\"vtkMRMLFiducialListNode1\" name=\""
           ...
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkMRMLFiducialListStorageNode1\" userTags=\"\" symbolScale=\"5\" symbolType=\"13\" "
              "textScale=\"4.5\" visibility=\"1\" color=\"0.4 1 1\" selectedcolor=\"1 0.5 0.5\" ambient=\"0\" "
              "diffuse=\"1\" specular=\"0\" power=\"1\" locked=\"0\" opacity=\"1\" fiducials=\"\n";
    ...
    myfile << "<FiducialListStorage\n id=\"vtkMRMLFiducialListStorageNode1\" name=\"vtkMRMLFiducialListStorageNode1\" "
              "hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" fileName=\""
  ...
  if (outputLandmarksInInputSpace.compare("") != 0)
  {
    myfile << "<FiducialList\n id=\"vtkMRMLFiducialListNode2\" name=\""
           << outputLandmarksInInputSpaceFullFilenameWithoutExtension
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkMRMLFiducialListStorageNode2\" userTags=\"\" symbolScale=\"5\" symbolType=\"13\" "
              "textScale=\"4.5\" visibility=\"1\" color=\"0.4 1 1\" selectedcolor=\"1 0.5 0.5\" ambient=\"0\" "
              "diffuse=\"1\" specular=\"0\" power=\"1\" locked=\"0\" opacity=\"1\" fiducials=\"\n";
    ...
    myfile << "<FiducialListStorage\n id=\"vtkMRMLFiducialListStorageNode2\" name=\"vtkMRMLFiducialListStorageNode2\" "
              "hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" fileName=\""
  ...
  if (outputVolume.compare("") != 0)
  {
    ...
    myfile << "<VolumeArchetypeStorage\n id=\"vtkMRMLVolumeArchetypeStorageNode1\" "
              "name=\"vtkMRMLVolumeArchetypeStorageNode1\" hideFromEditors=\"true\" selectable=\"true\" "
              "selected=\"false\" fileName=\""
           << outputVolumeFullFilename
           << "\" useCompression=\"1\" readState=\"0\" writeState=\"0\" centerImage=\"0\" singleFile=\"0\" "
              "UseOrientationFromFile=\"1\"></VolumeArchetypeStorage>\n";
    ...
    myfile << "\" spacing=\"" << doubleToString(spacing[0]) << " " << doubleToString(spacing[1]) << " "
           ...
           << "\" labelMap=\"0\"></Volume>\n<VolumeDisplay\n id=\"vtkMRMLScalarVolumeDisplayNode1\" "
              ...
              "diffuse=\"1\" selectedSpecular=\"0.5\" specular=\"0\" power=\"1\" opacity=\"1\" visibility=\"true\" "
              "clipping=\"false\" sliceIntersectionVisibility=\"false\" backfaceCulling=\"true\" "
              "scalarVisibility=\"false\" vectorVisibility=\"false\" tensorVisibility=\"false\" "
              "autoScalarRange=\"true\" scalarRange=\"0 100\" colorNodeRef=\"vtkMRMLColorTableNodeGrey\"  "
              "window=\"204\" level=\"153\" upperThreshold=\"32767\" lowerThreshold=\"-32768\" interpolate=\"1\" "
              "autoWindowLevel=\"1\" applyThreshold=\"0\" autoThreshold=\"0\"></VolumeDisplay>\n";
  }
  ...
  if (inputVolume.compare("") != 0)
  {
    ...
    myfile << "<VolumeArchetypeStorage\n id=\"vtkMRMLVolumeArchetypeStorageNode2\" "
              "name=\"vtkMRMLVolumeArchetypeStorageNode2\" hideFromEditors=\"true\" selectable=\"true\" "
              "selected=\"false\" fileName=\""
  ...
  if (outputTransform.compare("") != 0)
  {
    ...
    myfile << "<TransformStorage  \n  id=\"vtkMRMLTransformStorageNode1\"  name=\"vtkMRMLTransformStorageNode1\"  "
              "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  fileName=\""
