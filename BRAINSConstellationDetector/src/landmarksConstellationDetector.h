...
public:
  ...
  SImageType::Pointer
  GetOriginalInputImage( void ) const
  {
  ...
  double
  GetModelHeight( std::string PointName )
  {
  ...
  GetCenterOfHeadMassMSP( void ) const
  {
...
private:
  ...
  VersorTransformType::Pointer
  ComputeACPCAlignedZeroCenteredTransform( void );
