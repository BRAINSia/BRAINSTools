...
do
   ...
   currentXMLFile="${currentTargetDirectory}/${Date}.xml"
   echo " \${BRAINSBuild}/BRAINSCut --netConfiguration  ${currentXMLFile} --createVectors --trainModel --generateProbability --method RandomForest">>$QSUBFile
