...
void
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::PrintSelf( std::ostream & os, Indent indent ) const
{
  unsigned i;
...
template < typename TInputImage, typename TRealType, typename TOutputImage >
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::DivergenceImageFilter()
{
...
template < typename TInputImage, typename TRealType, typename TOutputImage >
void
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::SetUseImageSpacing( const bool newUseSpacing )
{
  if ( m_UseImageSpacing == newUseSpacing )
  {
    return;
  }
  ...
  if ( newUseSpacing == false && m_UseImageSpacing == true )
  {
    for ( unsigned int i = 0; i < ImageDimension; ++i )
    {
      m_DerivativeWeights[i] = static_cast< TRealType >( 1.0 );
  ...
  m_UseImageSpacing = newUseSpacing;
}

template < typename TInputImage, typename TRealType, typename TOutputImage >
void
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::GenerateInputRequestedRegion()
{
...
template < typename TInputImage, typename TRealType, typename TOutputImage >
void
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::BeforeThreadedGenerateData()
{
  ...
  if ( m_UseImageSpacing == true )
  {
    for ( unsigned i = 0; i < ImageDimension; i++ )
    {
      ...
      m_DerivativeWeights[i] =
        static_cast< TRealType >( 1.0 / static_cast< TRealType >( this->GetInput()->GetSpacing()[i] ) );
    }
  }
...
template < typename TInputImage, typename TRealType, typename TOutputImage >
void
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::ThreadedGenerateData(
...
template < typename TInputImage, typename TRealType, typename TOutputImage >
int
DivergenceImageFilter< TInputImage, TRealType, TOutputImage >::CubicSolver( double * c, double * s )
{
  // IMPORTANT
