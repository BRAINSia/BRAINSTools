...
#ifndef __itkQuadEdgeMeshBoundarySmoothFilter_txx
#define __itkQuadEdgeMeshBoundarySmoothFilter_txx
...
::GetInputMesh1() const
  ...
  const InputMeshType * inputMesh1 =
...
::GetInputMesh2() const
  {
  Self *                surrogate = const_cast<Self *>( this );
  const InputMeshType * inputMesh2 =
...
::GetOutputMesh1()
  {
  Self *           surrogate = const_cast<Self *>( this );
  OutputMeshType * outputMesh1 =
    static_cast<OutputMeshType *>( surrogate->ProcessObject::GetOutput(0) );
...
::GetOutputMesh2()
  {
  Self *           surrogate = const_cast<Self *>( this );
  OutputMeshType * outputMesh2 =
    static_cast<OutputMeshType *>( surrogate->ProcessObject::GetOutput(1) );
