...
public:
  ...
  int ExistImageOrientationPatient( float * directionCosine )
  {
    ...
    float a =
      sqrt(
        directionCosine[0] * directionCosine[0] + directionCosine[1] * directionCosine[1] + directionCosine[2]
        * directionCosine[2] );
    ...
    a = sqrt(
        directionCosine[3] * directionCosine[3] + directionCosine[4] * directionCosine[4] + directionCosine[5]
        * directionCosine[5] );
    for( int k = 3; k < 6; k++ )
      {
      directionCosine[k] /= a;
  ...
  const char * GetNthFileName( int idxSeriesInstanceUID, int idxContentTime, int idxTriggerTime, int idxEchoNumbers,
