...
#define vtkITKExecuteDataFromSeries(typeN, type) \
  case typeN: \
    ...
    (dynamic_cast<vtkImageData *>( output) )->GetPointData()->GetScalars()->SetVoidArray(ptr, \
                                                                                         PixelContainer##typeN->Size(), \
                                                                                         0); \
...
void vtkITKArchetypeImageSeriesScalarReader::ReadProgressCallback(itk::ProcessObject* obj, const itk::ProgressEvent &,
                                                                  void* data)
{
