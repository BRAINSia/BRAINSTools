...
public:
  ...
  {
    return vcl_numeric_limits<long long>::min();
  }

  static long long max()
  {
    return vcl_numeric_limits<long long>::max();
  }

  static long long min( long long )
  {
    return vcl_numeric_limits<long long>::min();
  }

  static long long max( long long )
  {
    return vcl_numeric_limits<long long>::max();
  }

  static long long NonpositiveMin()
  {
    return vcl_numeric_limits<long long>::min();
  }

  static bool IsPositive(long long val)
  {
    return val > Zero;
  }

  static bool IsNonpositive(long long val)
  {
    return val <= Zero;
  }

  static bool IsNegative(long long val)
  {
    return val < Zero;
  }

  static bool IsNonnegative(long long val)
  {
    return val >= Zero;
  }

  static long long  ZeroValue()
  {
    return Zero;
  }
};
...
public:
  ...
  {
    return vcl_numeric_limits<unsigned long long>::min();
  }

  static unsigned long long max()
  {
    return vcl_numeric_limits<unsigned long long>::max();
  }

  static unsigned long long min( unsigned long long )
  {
    return vcl_numeric_limits<unsigned long long>::min();
  }

  static unsigned long long max( unsigned long long )
  {
    return vcl_numeric_limits<unsigned long long>::max();
  }

  static unsigned long long NonpositiveMin()
  {
    return vcl_numeric_limits<unsigned long long>::min();
  }

  static bool IsPositive(unsigned long long val)
  {
    return val != Zero;
  }

  static bool IsNonpositive(unsigned long long val)
  {
    return val == Zero;
  }

  static bool IsNegative(unsigned long long)
  {
    return false;
  }

  static bool IsNonnegative(unsigned long long)
  {
    return true;
  }

  static unsigned long long  ZeroValue()
  {
    return Zero;
  }
};
