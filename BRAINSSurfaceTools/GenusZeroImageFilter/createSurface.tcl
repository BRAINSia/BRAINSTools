...
proc Genus0SurfaceGeneration { T1NormalizeBfc TissueClassImage Brain Ventricle LeftCaudate RightCaudate LeftPutamen RightPutamen LeftThalamus RightThalamus ResultDir PatientId ScanId } {    
  global BrainsConfig    
  ...
  set clipT1Filename $WorkDir/${ScanId}_T1_clip.nii.gz    
  ...
  if {[Brains::Utils::CheckOutputsNewer [list $clipT1Filename] \
...
set baseDir /home/vince/images/surface/0118695 
#set baseDir /Users/vince/images/surface/0118695 
set T1NormalizeBfc $baseDir/0118695_T1.hdr 
set TissueClassImage $baseDir/0118695_class.hdr 
set BrainMask $baseDir/0118695_brain_trim.mask 
set Ventricle $baseDir/0118695_ventricles.hdr 
