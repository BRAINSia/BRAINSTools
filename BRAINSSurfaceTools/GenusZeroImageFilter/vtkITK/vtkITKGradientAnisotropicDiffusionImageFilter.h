/*=========================================================================
  ...
  Date:      $Date: 2006-12-21 06:21:52 -0600 (Thu, 21 Dec 2006) $
  Version:   $Revision: 1900 $

==========================================================================*/

// .NAME vtkITKGradientAnisotropicDiffusionImageFilter - Wrapper class around
...
protected:
  //BTX
  typedef itk::GradientAnisotropicDiffusionImageFilter<Superclass::InputImageType,
                                                       Superclass::InputImageType> ImageFilterType;
  ...
  //ETX
private:
  vtkITKGradientAnisotropicDiffusionImageFilter(const vtkITKGradientAnisotropicDiffusionImageFilter &); //
                                                                                                        // Not
                                                                                                        // implemented.
  void operator=(const vtkITKGradientAnisotropicDiffusionImageFilter &);                                //
                                                                                                        // Not
                                                                                                        // implemented.
};
