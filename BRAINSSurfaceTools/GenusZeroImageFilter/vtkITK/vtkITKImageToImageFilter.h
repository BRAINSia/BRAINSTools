/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilter.h $
  Date:      $Date: 2008-10-12 13:27:24 -0500 (Sun, 12 Oct 2008) $
  Version:   $Revision: 7669 $
  ...
  void Update()
  {
    if ( this->GetOutput(0) )
      ...
      if ( this->GetOutput(0)->GetSource() )
        {
        //          this->SetErrorCode(
        // this->GetOutput(0)->GetSource()->GetErrorCode() );
        }
      }
  }
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilter(const vtkITKImageToImageFilter &); // Not
                                                              // implemented.
  void operator=(const vtkITKImageToImageFilter &);           // Not
                                                              // implemented.
};
