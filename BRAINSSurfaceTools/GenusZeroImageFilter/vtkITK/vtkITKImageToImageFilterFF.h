/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterFF.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterFF(const vtkITKImageToImageFilterFF &); // Not
                                                                  // implemented.
  void operator=(const vtkITKImageToImageFilterFF &);             // Not
                                                                  // implemented.
};
