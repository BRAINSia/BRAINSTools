/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterFUL.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterFUL(const vtkITKImageToImageFilterFUL &); // Not
                                                                    // implemented.
  void operator=(const vtkITKImageToImageFilterFUL &);              // Not
                                                                    // implemented.
};
