/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterSS.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterSS(const vtkITKImageToImageFilterSS &); // Not
                                                                  // implemented.
  void operator=(const vtkITKImageToImageFilterSS &);             // Not
                                                                  // implemented.
};
