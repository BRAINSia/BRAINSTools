/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterULUL.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterULUL(const vtkITKImageToImageFilterULUL &); // Not
                                                                      // implemented.
  void operator=(const vtkITKImageToImageFilterULUL &);               // Not
                                                                      // implemented.
};
