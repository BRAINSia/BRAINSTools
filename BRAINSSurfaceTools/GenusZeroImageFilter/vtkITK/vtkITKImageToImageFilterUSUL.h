/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterUSUL.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterUSUL(const vtkITKImageToImageFilterUSUL &); // Not
                                                                      // implemented.
  void operator=(const vtkITKImageToImageFilterUSUL &);               // Not
                                                                      // implemented.
};
