/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKImageToImageFilterUSUS.h $
...
protected:
  ...
  //ETX
private:
  vtkITKImageToImageFilterUSUS(const vtkITKImageToImageFilterUSUS &); // Not
                                                                      // implemented.
  void operator=(const vtkITKImageToImageFilterUSUS &);               // Not
                                                                      // implemented.
};
