...
// .NAME vtkITKIslandMath - ITK-based utilities for manipulating connected
...
public:
  ...
  // Description:
  // If non-zero, islands are defined by pixels that touch on edges and/or
  // vertices.
  // If zero, pixels are only considered part of the same island if their
  // faces/edges touch
