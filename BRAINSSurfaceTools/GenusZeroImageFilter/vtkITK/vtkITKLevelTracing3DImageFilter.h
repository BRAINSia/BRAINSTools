...
=========================================================================*/
// .NAME vtkITKLevelTracing3DImageFilter - Wrapper class around
...
protected:
  ...
  int Seed[3];
private:
  vtkITKLevelTracing3DImageFilter(const vtkITKLevelTracing3DImageFilter &); //
                                                                            // Not
                                                                            // implemented.
  void operator=(const vtkITKLevelTracing3DImageFilter &);                  //
                                                                            // Not
                                                                            // implemented.
};
