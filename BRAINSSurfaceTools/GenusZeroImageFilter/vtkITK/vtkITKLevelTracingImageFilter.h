...
=========================================================================*/
// .NAME vtkITKLevelTracingImageFilter - Wrapper class around
...
protected:
  ...
  int Plane;
private:
  vtkITKLevelTracingImageFilter(const vtkITKLevelTracingImageFilter &); // Not
                                                                        // implemented.
  void operator=(const vtkITKLevelTracingImageFilter &);                // Not
                                                                        // implemented.
};
