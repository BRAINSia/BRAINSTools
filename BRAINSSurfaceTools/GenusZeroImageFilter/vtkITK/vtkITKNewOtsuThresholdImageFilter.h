...
/*=========================================================================
  ...
  Version:   $Revision: 1.1.2.1 $
*/
// .NAME vtkITKNewOtsuThresholdImageFilter - Wrapper class around
// itk::NewOtsuThresholdImageFilter
// .SECTION Description
...
protected:
  ...
  //ETX
private:
  vtkITKNewOtsuThresholdImageFilter(const vtkITKNewOtsuThresholdImageFilter &); //
                                                                                // Not
                                                                                // implemented.
  void operator=(const vtkITKNewOtsuThresholdImageFilter &);                    //
                                                                                // Not
                                                                                // implemented.
};
