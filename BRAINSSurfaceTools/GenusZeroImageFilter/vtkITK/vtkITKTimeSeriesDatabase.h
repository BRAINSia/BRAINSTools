...
// .NAME vtkITKTimeSeriesDatabase - Effeciently process large datasets in small
// memory
// .SECTION Description
...
public:
  ...
  // void Connect ( const char* filename ) { this->m_Filter->Connect ( filename
  // ); this->Modified(); };
...
private:
  vtkITKTimeSeriesDatabase(const vtkITKTimeSeriesDatabase &); // Not
                                                              // implemented.
  void operator=(const vtkITKTimeSeriesDatabase &);           // Not
                                                              // implemented.
};
