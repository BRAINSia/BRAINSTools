/*=========================================================================
  ...
  Program:   vtkITK
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Libs/vtkITK/vtkITKUtility.h $
...
// {
//   ProgressDisplay(vtkObject* obj, itk::ProcessObject* process):
// m_Process(process), m_Object(obj) {}
