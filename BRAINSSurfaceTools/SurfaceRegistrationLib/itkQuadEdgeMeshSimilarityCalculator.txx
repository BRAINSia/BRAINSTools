/*=========================================================================
  ...
  Module:    $RCSfile: itkQuadEdgeMeshSimilarityCalculator.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkQuadEdgeMeshSimilarityCalculator_txx
#define __itkQuadEdgeMeshSimilarityCalculator_txx
...
::Compute()
{
  ...
  CellsContainerConstIterator2 cellEnd2 = cells2->End();
