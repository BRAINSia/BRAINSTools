...
void vtkTalairachConversion::Initialize()
{
...
int vtkTalairachConversion::AddTalairachBox(std::string talairachBox)
{
...
void vtkTalairachConversion::RemoveTalairachBox(std::string talairachBox)
{
  TalairachBoxList.remove(talairachBox);
}

void vtkTalairachConversion::RemoveTalairachBox(int index)
{
...
void vtkTalairachConversion::EraseTalairachBoxList()
{
  this->TalairachBoxList.clear();
}

void vtkTalairachConversion::SetHemisphereMode(int mode)
{
  this->HemisphereMode = mode;
}

void vtkTalairachConversion::SetHemisphereModeBoth()
{
  this->HemisphereMode = both;
}

void vtkTalairachConversion::SetHemisphereModeLeft()
{
  this->HemisphereMode = left;
}

void vtkTalairachConversion::SetHemisphereModeRight()
{
  this->HemisphereMode = right;
}

int vtkTalairachConversion::GetHemisphereMode()
{
  return this->HemisphereMode;
}

void vtkTalairachConversion::SetSegmentationMode(bool mode)
{
  this->SegmentationMode = mode;
}

void vtkTalairachConversion::SetSegmentationModeOn()
{
  this->SegmentationMode = true;
}

void vtkTalairachConversion::SetSegmentationModeOff()
{
  this->SegmentationMode = false;
}

bool vtkTalairachConversion::GetSegmentationMode()
{
  return this->SegmentationMode;
}

void vtkTalairachConversion::PrintSelf(ostream & os, vtkIndent indent)
{
  ...
  switch( this->HemisphereMode )
    {
    case right:
      os << "Right" << std::endl; break;
    case left:
      os << "Left" << std::endl; break;
    case both:
      os << "Both" << std::endl; break;
    }
}

void vtkTalairachConversion::SetTalairachGrid( vtkStructuredGrid *grid)
{
  this->TalairachGrid = grid;
}

vtkStructuredGrid * vtkTalairachConversion::GetTalairachGrid()
{
  return this->TalairachGrid;
}

void vtkTalairachConversion::ProcessBOX(bool _left)
{
  std::list<std::string>::iterator it;
  ...
  for( it = TalairachBoxList.begin(); it != TalairachBoxList.end(); ++it )
    ...
    ImageType::RegionType::SizeType imageSize
      = this->MaskImage->GetLargestPossibleRegion().GetSize();
    for( int i = 0; i < 3; i++ )
      {
      if( gridStart[i] < 0 )
        {
...
void vtkTalairachConversion::SetImageInformation(ImageType::Pointer exampleImage)
{
...
vtkTalairachConversion::ImageType::Pointer vtkTalairachConversion::GetImage()
{
  return this->MaskImage;
}

void vtkTalairachConversion::Update()
{
