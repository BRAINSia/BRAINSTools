...
int * vtkTalairachGrid::GetBoundingBoxDimensions()
{
  return ( this->boundingBoxGrid )->GetDimensions();
}

int * vtkTalairachGrid::GetTalairachGridDimensions()
{
  return ( this->talairachGrid )->GetDimensions();
}

void vtkTalairachGrid::SetACPoint(double ac[3])
{
  ACPoint[0] = ac[0];
  ACPoint[1] = ac[1];
  ACPoint[2] = ac[2];
...
void vtkTalairachGrid::SetPCPoint(double pc[3])
{
  PCPoint[0] = pc[0];
  PCPoint[1] = pc[1];
  PCPoint[2] = pc[2];
...
void vtkTalairachGrid::SetIRPPoint(double irp[3])
{
  IRPPoint[0] = irp[0];
  IRPPoint[1] = irp[1];
  IRPPoint[2] = irp[2];
...
void vtkTalairachGrid::SetSLAPoint(double sla[3])
{
  SLAPoint[0] = sla[0];
  SLAPoint[1] = sla[1];
  SLAPoint[2] = sla[2];
...
double * vtkTalairachGrid::GetACPoint()
{
  return this->ACPoint;
}

double * vtkTalairachGrid::GetPCPoint()
{
  return this->PCPoint;
}

double * vtkTalairachGrid::GetIRPPoint()
{
  return this->IRPPoint;
}

double * vtkTalairachGrid::GetSLAPoint()
{
  return this->SLAPoint;
}

vtkStructuredGrid * vtkTalairachGrid::GetTalairachGrid()
{
...
vtkStructuredGrid * vtkTalairachGrid::GetBoundingBoxGrid()
{
  return this->boundingBoxGrid;
}

void vtkTalairachGrid::SetTalairachGrid( vtkStructuredGrid *grid)
{
...
void vtkTalairachGrid::SetBoundingBoxGrid( vtkStructuredGrid *box)
{
  // this->boundingBoxGrid = box;
  boundingBoxGrid->DeepCopy(box);
}

vtkPoints * vtkTalairachGrid::GetTalairachGridPoints()
{
  return this->talairachGridPoints;
}

vtkPoints * vtkTalairachGrid::GetBoundingBoxGridPoints()
{
  return this->boundingBoxGridPoints;
}

#if 0
void vtkTalairachGrid::EstablishBoundingBoxGrid()
{
...
void vtkTalairachGrid::EstablishTalairachGrid()
{
...
void vtkTalairachGrid::WriteBoundingBoxGrid(std::string filename)
{
  vtkStructuredGridWriter *gridWriter = vtkStructuredGridWriter::New();
...
void vtkTalairachGrid::PrintSelf(ostream & os, vtkIndent indent)
{
  ...
  os << indent << "Box Dimensions: (" << boxDim[0] << ", "
     << boxDim[1] << ", "
     << boxDim[2] << ")\n";

  os << indent << "Grid Dimensions: (" << gridDim[0] << ", "
     << gridDim[1] << ", "
     << gridDim[2] << ")\n";
...
std::vector<double> vtkTalairachGrid::ConvertTalairachPointToPixelPoint(double *talPoint)
{
...
std::vector<double> vtkTalairachGrid::ConvertPixelPointToTalairachPoint(double *voxelPoint)
{
