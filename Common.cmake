...
# VTK version options
#-----------------------------------------------------------------------------
option(USE_VTK_VERSION_6                     "Use VTK Version 6"                     OFF)
...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${C_DEBUG_DESIRED_FLAGS} -DITK_FUTURE_LEGACY_REMOVE " )
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CXX_DEBUG_DESIRED_FLAGS} -DITK_FUTURE_LEGACY_REMOVE " )
else() # Release, or anything else
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${C_RELEASE_DESIRED_FLAGS} -DITK_FUTURE_LEGACY_REMOVE " )
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CXX_RELEASE_DESIRED_FLAGS} -DITK_FUTURE_LEGACY_REMOVE " )
endif()
