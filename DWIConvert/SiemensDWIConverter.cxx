...
bool
SiemensDWIConverter::ExtractGradientDirection(CSAHeader *                   csaHeader,
                                              unsigned int                  strideVolume,
...
bool
SiemensDWIConverter::ExtractBMatrix(CSAHeader *                      csaHeader,
                                    unsigned int                     strideVolume,
 ...
 */
unsigned int
SiemensDWIConverter::ExtractSiemensDiffusionInformation(const std::string &   tagString,
