...
int
readFileIntoBuffer( const char * filename, char ** buffer )
{
...
DataVector
convertBufferIntoVector( char * buffer )
{
...
int
compareRowColumn( const DataVector & data1, const DataVector & data2, const size_t linesToCompare,
