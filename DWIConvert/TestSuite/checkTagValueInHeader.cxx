...
printUsage( char * argv0 )
{
  ...
  std::cout << "Usage:" << std::endl
            << argv0
            << " --f HeaderFileName --tag TagName --section sectionIndex --subsection subsectionIndex --v "
               "verifyingValue --numtype <1|0>"
            << std::endl
            << "Notes: index is from 0 to count after the tag" << std::endl;
  std::cout << "Example:" << std::endl
            << "For a line text: space directions: (0.9343162500000001,0.07719215625,0) "
               "(-0.07719215625,0.9343162500000001,0) (0,0,5.999994770777341) none ,"
            << std::endl
