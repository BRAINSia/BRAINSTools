...
#ifndef __itkOrientScalarImageFilter_h
#define __itkOrientScalarImageFilter_h
 ...
 *
 * OrientScalarImageFilter depends on a set of constants that describe all possible
 ...
 *   itk::OrientScalarImageFilter<ImageType,ImageType>::Pointer orienter =
 *     itk::OrientScalarImageFilter<ImageType,ImageType>::New();
...
class ITK_EXPORT OrientScalarImageFilter :
  public         ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef OrientScalarImageFilter Self;
  ...
  itkTypeMacro(OrientScalarImageFilter, ImageToImageFilter);
  ...
  /** OrientScalarImageFilter produces an image which is a different
   * dimensionality than its input image, in general.
   *As such, OrientScalarImageFilter needs to provide an
...
protected:
  ...
  /** OrientScalarImageFilter needs the entire input be
   * available. Thus, it needs to provide an implementation of
   * GenerateInputRequestedRegion(). */
  void GenerateInputRequestedRegion();

  /** OrientScalarImageFilter will produce the entire output. */
...
private:
  OrientScalarImageFilter(const Self &); // purposely not implemented
...
#include "itkOrientScalarImageFilter.txx"
#endif
