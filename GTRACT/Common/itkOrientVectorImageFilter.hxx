...
#ifndef __itkOrientVectorImageFilter_hxx
#define __itkOrientVectorImageFilter_hxx
...
#include <itkConstantPadVectorImageFilter.h>
...
OrientVectorImageFilter<TInputImage, TOutputImage>
...
::GenerateData()
{
  ...
  // The indented stuff here is from bkItkPermuteAxes.hxx (brains2)
  ...
  // Convenient typedefs
  typedef ConstantPadVectorImageFilter<InputImageType, CubeImageType> PadInputFilterType;
