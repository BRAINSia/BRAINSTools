...
#ifndef __itkTimeSeriesVersorRigidFilter_h
#define __itkTimeSeriesVersorRigidFilter_h
...
class GTRACT_COMMON_EXPORT TimeSeriesVersorRigidFilter : public itk::Object
{
public:
  /** Standard class typedefs. */
  typedef TimeSeriesVersorRigidFilter Self;
...
protected:
  TimeSeriesVersorRigidFilter();
  ~TimeSeriesVersorRigidFilter()
  {
  }

private:
  TimeSeriesVersorRigidFilter(const Self &); // purposely not implemented
