...
/**
 * ITKToMType -- use template function to map ITK/native scalar typesto Matlab scalar types.
 */
...
template<typename TImage> void BuildMatlabStruct(mxArray *&structMx, typename TImage::Pointer im) {
...
/** do the actual load */
template<typename TImage> void LoadDWIImage(const std::string &filename, mxArray *&structMx) {
    typedef TImage ImageType;
