...
template <>
void
CopyImageData< itk::VectorImage< double, 3 > >( itk::VectorImage< double, 3 >::Pointer & im, void * target,
...
template <>
void
CopyImageData< itk::VectorImage< float, 3 > >( itk::VectorImage< float, 3 >::Pointer & im, void * target,
                                               unsigned long numPixels )
{
...
template <>
void
CopyImageData< itk::VectorImage< short, 3 > >( itk::VectorImage< short, 3 >::Pointer & im, void * target,
                                               unsigned long numPixels )
{
...
BuildMatlabStruct( mxArray *& structMx, typename TImage::Pointer im, const std::string & filename )
{
  ...
  *space_temp = nrrdSpaceLeftPosteriorSuperior;
  ...
  if ( itk::ExposeMetaData< std::vector< std::vector< double > > >(
         thisDic, measurementFrameFieldName, measurementFrame ) != false )
  {
...
void
itkLoadWithMetadata( int, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
