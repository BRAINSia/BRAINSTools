...
# BRAINSTools_EP_GIT_SHALLOW (default OFF):
#   OFF — full git clone for all ExternalProject dependencies (safe for local
#         developer builds where history and tag resolution matter).
#   ON  — depth-1 shallow clone; reduces first-time EP download time from
#         minutes to seconds.  Set ON in CI via -DBRAINSTools_EP_GIT_SHALLOW=ON.
option(BRAINSTools_EP_GIT_SHALLOW
  "Use shallow (depth-1) git clones for ExternalProject downloads. \
Recommended ON for CI; leave OFF for local developer builds."
  OFF)
mark_as_advanced(BRAINSTools_EP_GIT_SHALLOW)
