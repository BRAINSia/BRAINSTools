...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(${proj}_GIT_TAG "v8.2.0")  # VTK 9.0 is too new without stable API, stick to v8.2.0
  ...
  set(${proj}_DIR ${CMAKE_INSTALL_PREFIX}) #${CMAKE_CURRENT_BINARY_DIR}/${proj}-${EXTERNAL_PROJECT_BUILD_TYPE}-build)
