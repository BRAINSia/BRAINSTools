...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  # SMP backend: TBB when BRAINSTools_REQUIRES_TBB is ON, otherwise Sequential
  if(${SUPERBUILD_TOPLEVEL_PROJECT}_REQUIRES_TBB)
    set(_vtk_smp_type "TBB")
  else()
    set(_vtk_smp_type "Sequential")
  endif()
  ...
  ExternalProject_Add(${proj}
    ...
    GIT_SUBMODULES ""  # VTK 9.x has no submodules; prevents false-failure in CMake 3.26
    ...
    CMAKE_CACHE_ARGS
      ...
      ${EXTERNAL_PROJECT_OPTIONAL_VTK9_CMAKE_CACHE_ARGS}
      ...
      # TBB — use TBB SMP backend when BRAINSTools_REQUIRES_TBB, else Sequential
      -DVTK_SMP_IMPLEMENTATION_TYPE:STRING=${_vtk_smp_type}
      -DTBB_DIR:PATH=${TBB_DIR}
    INSTALL_COMMAND ""
    DEPENDS
      ${${proj}_DEPENDENCIES}
