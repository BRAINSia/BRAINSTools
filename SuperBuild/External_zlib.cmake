...
if(NOT DEFINED zlib_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  if(BUILD_SHARED_LIBS)
    set(ZLIB_LIBRARY ${zlib_DIR}/${CMAKE_INSTALL_LIBDIR}/libzlib${CMAKE_SHARED_LIBRARY_SUFFIX})
  else()
    set(ZLIB_LIBRARY ${zlib_DIR}/${CMAKE_INSTALL_LIBDIR}/libzlib${CMAKE_STATIC_LIBRARY_SUFFIX})
  endif()
else()
