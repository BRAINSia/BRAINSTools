...
if __name__ == "__main__":
    ...
    if fileName[-4:] == ".md5":
        print(f"Skipping md5 file:  {fileName}")
        exit(0)
    ...
    if os.path.exists(finalDestination):
        print(f"Destination file already exists: SKIPPING {finalDestination}")
    else:
    ...
    if args.destPath != defaultCMakeRepository:
        print(
            "rsync -av {}/ neuron.psychiatry.uiowa.edu:{}/".format(
